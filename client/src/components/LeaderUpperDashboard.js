...
export default function MemberUpperDashboard({
    ...
    let compTask = area.users.map((user) =>
        user.tasks
            .filter((comp) => comp.isCompleted)
            .map((tas) => {
    ...
    return (
        <section className=' font-poppins'>
            <div className='lg:flex-row lg:flex md:flex-col justify-between mt-5 mb-1'>
                ...
                <div className='flex flex-col lg:items-center gap-10 lg:flex-row lg:h-40 lg:mt-8 overflow-x-auto overflow-hidden ml-4'>
                    <Card>
