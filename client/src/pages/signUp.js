                        ...
                        <div className='flex flex-col items-center border-2 rounded-2xl border-slate-200 py-8 px-4 md:px-20 lg:px-14 lg:py-14 gap-8'>
                            ...
                            <div className='flex flex-col md:flex-row lg:flex-row px-4  md:px-0 gap-8'>
                                <button
                                    ...
                                    className={
                                        !isEmployee
                                            ? "w-56 h-[150px] px-4 py-4 gap-4 border-2 rounded-2xl border-slate-200 lg:hover:border-white cursor-pointer focus:outline-none flex flex-col items-end flex-shrink-0"
                                            : "w-56 h-[150px] px-4 py-4 gap-4 border-4 rounded-2xl border-slate-200 lg:hover:border-white cursor-pointer focus:outline-none flex flex-col items-end flex-shrink-0"
                                    }
                                >
                                    <div
                                        className={
                                            !isEmployee
                                                ...
                                                : "visible btn-employee border-slate-200 bg-slate-200 rounded-full w-8 h-8 flex-shrink-0"
                                        }
                                    ></div>
                                    <h1 className='text-slate-200 font-medium text-sm text-left flex-grow max-w-xs'>
                                        I'm an employee, looking to keep track
                                        of my achievements
                                    </h1>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    ></div>
                                    <h1 className='text-slate-200 font-medium text-sm text-left flex-grow max-w-xs'>
                                        I’m an employer, looking to increase
                            ...
                            <div className='flex text-center px-4'>
                                <Link
                                    ...
                                    className='flex bg-slate-200 text-neutral-950 py-4 px-4 font-bold font-poppins rounded-full lg:text-lg justify-center w-48 md:w-96 cursor-pointer hover:bg-slate-100'
                                >
                                    Apply as{" "}
                                    {isEmployee ? "an Employee" : "an Employer"}
                                </Link>
                            </div>
