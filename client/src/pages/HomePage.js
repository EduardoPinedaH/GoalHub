                    ...
                    <div className='pb-10 md:pb-0 flex flex-row flex-wrap mt-10 justify-center gap-20 lg:flex-nowrap'>
                        <div className='hover:transition hover:scale-125 transition duration-300 ease-in-out'>
                            <img
                                src={avatar3}
                                alt='avatar3'
                                className='w-48 h-auto -mb-5 lg:w-52'
                            />
                            <p className=' text-slate-200 font-thin text-center lg:text-base'>
                                Keep tasks{" "}
                        ...
                        <div className='hover:transition hover:scale-125 transition duration-300 ease-in-out'>
                            ...
                            <p className='  text-slate-200 font-thin text-center lg:text-base'>
                                Find out others{" "}
                                <strong className=' font-bold'>goals</strong>.
                            </p>
                        </div>
                        <div className='hover:transition hover:scale-125 transition duration-300 ease-in-out'>
                            <img
